...
class kritik_saran extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('lab/m_kritik_saran');
	}
	...
	public function index()
	{
		...
		$this->load->view('lab/kritik_saran/v_kritik_saran_list',$data);
    }
    public function form($param='')
	{
		...
		if($param=='base'){
			$this->fungsi->run_js('load_silent("lab/kritik_saran/show_addForm/","#divsubcontent")');	
		}else{
			$base_kom=$this->uri->segment(5);
			$this->fungsi->run_js('load_silent("lab/kritik_saran/show_editForm/'.$base_kom.'","#divsubcontent")');	
		}
	}
	...
	public function show_addForm()
	{
		...
		{
			$data['status']='';
			$this->load->view('lab/kritik_saran/v_kritik_saran_add',$data);
		}
		else
		{
	...
	public function show_editForm($id='')
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$data['status']='';
			$this->load->view('lab/kritik_saran/v_kritik_saran_edit',$data);
		}
		else
		{
