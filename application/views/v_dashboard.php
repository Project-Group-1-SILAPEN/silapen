            ...
            <div class="box-footer">
              <div class="row">
                ...
                <?php echo $avatar; ?>
                    ...
                    <span class="description-text"><?php echo button('load_silent("cms/user/show_editForm_user/'.from_session('id').'","#content")','Update Profil','btn bg-blue','data-toggle="tooltip" title="Update Profil"');?> 
						</span>
                  </div>
