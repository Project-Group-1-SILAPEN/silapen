...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'file_jadwal','class'=>'form-control'));?>
            <?php echo form_error('file_jadwal');?>
            <span id="check_data"></span>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"kelola/kelola_jadwal/show_addForm/","#divsubcontent")','Save','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
