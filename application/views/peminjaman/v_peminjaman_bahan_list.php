        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            ...
            <?php
              ...
              if ($sesi == '1' || $sesi == '4' || $sesi == '5' || $sesi == '6'|| $sesi == '7'|| $sesi == '8') {
                echo button('load_silent("peminjaman/peminjaman_bahan/form/base","#modal")','Add New Peminjaman Bahan','btn btn-success');
              } else {
                # code...
              }
              ?>
          ...
          <tr>
            ...
            <?php
              ...
              ?>
              <?php echo button('load_silent("peminjaman/peminjaman_bahan/delete/'.$row->id.'","#content")','','btn btn-danger fa fw fa-trash','data-toggle="tooltip" title="Hapus"');?> 
            </td>
          </tr>
